$(".modal-edit").click(function(event) {
  ...
  Rails.ajax({
    ...
    success: function(data) {
      ...
      $("#edit_business #date_purchased_or_sold").val(
        data.date_purchased_or_sold
      );
      ...
      $("#edit_business #does_company_have_employees").val(
        data.does_company_have_employees
      );
      $("#edit_business #qualified_plan_sponsored").val(
        data.qualified_plan_sponsored
      );
